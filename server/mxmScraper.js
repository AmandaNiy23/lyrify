		...
		request(headers, (err, resp, html) => {
			...
			if(!results || results.length < 1){
				return callback(null ,{
					lyrics: 'No result could be found',
				})
			} //return callback(new Error('No result could be found'));
            ...
            return callback(null ,{
              lyrics: 'No lyrics have been assigned to this song',
            })
					} else {
						return callback(null, {
